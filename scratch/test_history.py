...
if emp:
    print(f"Testing GET /api/salary/history?employee_id={emp.id}&from=2026-1&to=2026-6")
    response = client.get(f"/api/salary/history?employee_id={emp.id}&from=2026-1&to=2026-6")
